...
/**
 * Created by Viraloch on 19/3/2018.
 */
...
public class DataBaseHandler extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        String CREATE_CATEGORY_TABLE = "CREATE TABLE " + TABLE_STORE + "("
        ...
        db.execSQL("INSERT INTO " + TABLE_CITY + " (" +KEY_CITY_ID + "," + KEY_CITY_NAME + ") VALUES (8, 'Zapopa')");
        ...
        + ") VALUES ('BEST BUY', '01 800 237 8289', 2, 0, 20.6489713, -103.4207757)");
